  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 items-center min-h-[500px] lg:min-h-[600px]">
            ...
            <motion.div
              ...
              className="text-center lg:text-left order-2 lg:order-1 z-10 lg:pr-8"
            >
              {/* Pink subtitle */}
              <motion.p
                ...
                className="text-pink-400 text-sm md:text-base font-semibold mb-3 uppercase tracking-wider"
              >
                HỌC NHÓM DỄ DÀNG CÙNG STUDYSYNC
              </motion.p>
              ...
              <motion.h1
                ...
                className="text-2xl md:text-3xl lg:text-4xl font-bold text-purple-800 mb-5 leading-snug"
              >
                CÙNG NHAU HỌC TẬP <br /> VÀ TIẾN BỘ MỖI NGÀY
              </motion.h1>
              ...
              <motion.p
                ...
                className="text-gray-600 text-base md:text-lg mb-8 leading-relaxed max-w-xl"
              >
                Tạo nhóm học dễ dàng, chia sẻ kiến thức, call trực tuyến và cùng
                nhau đạt mục tiêu học tập – tất cả chỉ trong một nền tảng.
              </motion.p>
            ...
            <motion.div
              ...
              className="order-1 lg:order-2 lg:absolute lg:right-0 lg:top-0 lg:w-1/2 lg:h-full flex items-center justify-end"
            >
                ...
                <motion.img
                  ...
                  onError={(e) => {
                    ...
                    e.target.parentElement.innerHTML =
                      '<div class="w-full h-96 bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg flex items-center justify-center"><span class="text-purple-600 text-lg font-medium">StudySync</span></div>';
                  }}
      ...
      <section
        ...
        style={{
          background: "linear-gradient(135deg, #A640A0 0%, #6D17AE 100%)",
        }}
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            style={{ backgroundColor: "#8E2FA6" }}
          ></div>
          <div
            className="absolute top-32 right-20 w-24 h-24 rounded-full opacity-15"
            style={{ backgroundColor: "#8E2FA6" }}
          ></div>
          <div
          ...
          ></div>
          <div
            className="absolute top-1/2 right-10 w-28 h-28 rounded-full opacity-25"
            style={{ backgroundColor: "#8E2FA6" }}
          ></div>
          <div
            className="absolute top-3/4 left-1/2 transform -translate-x-1/2 w-64 h-64 rounded-full opacity-5"
            style={{ backgroundColor: "#8E2FA6" }}
          ></div>
          <div
            className="absolute top-1/3 right-1/3 w-20 h-20 rounded-full opacity-30"
            style={{ backgroundColor: "#8E2FA6" }}
          ></div>
          <div
            className="absolute bottom-1/4 left-1/2 w-36 h-36 rounded-full opacity-15"
            style={{ backgroundColor: "#8E2FA6" }}
          ></div>
          <div
          ...
          ></div>
          <div
            className="absolute bottom-32 right-16 w-32 h-32 rounded-full opacity-10"
            style={{ backgroundColor: "#8E2FA6" }}
          ></div>
        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-xl p-6 flex items-start space-x-4 shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Ghi nhớ kiến thức liên tục và hiệu quả
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 flex items-start space-x-4 shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">
                      Phòng học ảo tích hợp
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Học tập online hiệu quả với công nghệ tiên tiến
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 flex items-start space-x-4 shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">
                      AI giải bài & tạo đề cương
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Tạo bài tập và đề cương học tập
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 flex items-start space-x-4 shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">
                      Tự động sắp xếp lịch học nhóm
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Sắp xếp lịch học phù hợp cho mọi thành viên
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center text-white mb-20">
                ...
                <p className="text-lg text-purple-100 max-w-3xl mx-auto leading-relaxed">
                  Trải nghiệm những phương pháp học tập tiên tiến được hỗ trợ
                  bởi công nghệ AI và các giải pháp giáo dục thông minh
                </p>
              </div>
                  ...
                  <div className="relative h-80 overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-4 right-4">
                      ...
                      <p className="text-white/90 text-sm leading-relaxed mb-4">
                        Phương pháp học tập hiện đại với công nghệ AI giúp học
                        sinh tiếp thu kiến thức một cách trực quan và hiệu quả.
                      </p>
                ...
                <div className="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
                  <div className="relative h-80 overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-4 right-4">
                      ...
                      <p className="text-white/90 text-sm leading-relaxed mb-4">
                        Nền tảng học trực tuyến cho phép học sinh học tập mọi
                        lúc, mọi nơi với thiết bị di động.
                      </p>
                  ...
                  <div className="relative h-80 overflow-hidden">
                    <img
                      ...
                      onError={(e) => {
                        e.target.style.display = "none";
                        e.target.parentElement.style.background =
                          "linear-gradient(135deg, #06b6d4 0%, #3b82f6 50%, #4338ca 100%)";
                      }}
                    />
                    {/* Gradient overlay */}
                    ...
                    <div className="absolute bottom-6 left-4 right-4">
                      ...
                      <p className="text-white/90 text-sm leading-relaxed mb-4">
                        AI thông minh cá nhân hóa trải nghiệm học tập theo nhu
                        cầu và khả năng của từng học sinh.
                      </p>
              ...
              <div className="mb-16">
                <div className="text-center mb-12">
                  ...
                  <p className="text-purple-100 text-lg max-w-2xl mx-auto leading-relaxed">
                    Khám phá những bài viết chuyên sâu về phương pháp học tập
                    hiện đại, công nghệ giáo dục và xu hướng mới trong việc học
                    tập thông minh
                  </p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
                    <div className="relative h-52 overflow-hidden">
                      <img
                        ...
                        onError={(e) => {
                          e.target.style.display = "none";
                          e.target.parentElement.style.background =
                            "linear-gradient(135deg, #1e293b 0%, #3730a3 50%, #1e3a8a 100%)";
                        }}
                      />
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed mb-4">
                        Tìm hiểu cách AI có thể trở thành người bạn đồng hành
                        trong quá trình học tập, không chỉ hỗ trợ mà còn tạo
                        động lực và cá nhân hóa trải nghiệm học tập.
                      </p>
                  ...
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed mb-4">
                        Học nhóm online không chỉ là họp video đơn thuần. Khám
                        phá những phương pháp và công cụ hiệu quả để tối ưu hóa
                        việc học nhóm từ xa.
                      </p>
                      <div className="flex items-center justify-between">
                  ...
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
                    <div className="relative h-52 overflow-hidden">
                      ...
                      <div className="absolute inset-0 opacity-15">
                        <div className="absolute top-4 left-4 text-white text-xs animate-pulse">
                          {"{ }"}
                        </div>
                        <div className="absolute bottom-4 right-4 text-white text-xs animate-pulse delay-500">
                          {"< />"}
                        </div>
                        <div className="absolute top-1/2 left-8 text-white text-xs animate-pulse delay-1000">
                          {"#"}
                        </div>
                      </div>
                    </div>
                    <div className="p-6">
                      ...
                      <h4 className="font-bold text-gray-900 mb-3 text-lg group-hover:text-cyan-600 transition-colors">
                        Làm sao để công nghệ số trở thành công cụ học tập thông
                        minh?
                      </h4>
                      <p className="text-gray-600 text-sm leading-relaxed mb-4">
                        Tìm hiểu cách sử dụng công nghệ số một cách thông minh
                        và hiệu quả để nâng cao chất lượng học tập và phát triển
                        kỹ năng tư duy.
                      </p>
                      <div className="flex items-center justify-between">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-xl p-6 relative">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-3">
                      Lấy nghiệp học làm trong lòng
                    </h3>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Chúng tôi hiểu rằng học tập là một quá trình quan trọng và
                      cần được hỗ trợ tốt nhất. StudySync được ra đời với sứ
                      mệnh mang đến cho học sinh, sinh viên một môi trường học
                      tập hiện đại, thông minh và hiệu quả nhất.
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-6 relative">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-3">
                      Đội ngũ với cam kết hàng đầu
                    </h3>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Với đội ngũ chuyên gia giàu kinh nghiệm trong lĩnh vực
                      giáo dục và công nghệ, chúng tôi cam kết mang đến những
                      giải pháp học tập tốt nhất, giúp người học đạt được mục
                  ...
                  <div className="bg-white rounded-xl p-6 relative">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-3">
                      Kết hợp đổi chính thống
                    </h3>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      StudySync kết hợp phương pháp học tập truyền thống với
                      công nghệ AI tiên tiến, tạo ra một nền tảng học tập toàn
                      diện, phù hợp với mọi đối tượng người học.
                    </p>
                  </div>
                </div>
                ...
                <div className="text-white">
                  ...
                  <div className="space-y-4 text-sm leading-relaxed">
                    <p>
                      StudySync được phát triển bởi một nhóm sinh viên đam mê
                      công nghệ và giáo dục. Chúng tôi nhận thấy rằng việc học
                      nhóm và chia sẻ kiến thức là yếu tố quan trọng trong quá
                      trình học tập hiện đại.
                    </p>
                    <p>
                      Với sự kết hợp giữa trí tuệ nhân tạo và phương pháp học
                      tập truyền thống, StudySync mang đến một trải nghiệm học
                      tập hoàn toàn mới, giúp người học tối ưu hóa thời gian và
                      nâng cao hiệu quả học tập.
                    </p>
                    <p>
                      Chúng tôi tin rằng học tập không chỉ là việc tiếp thu kiến
                      thức mà còn là quá trình phát triển tư duy, kỹ năng và tạo
                      dựng mối quan hệ. StudySync được thiết kế để hỗ trợ tất cả
                      những khía cạnh này.
                    </p>
                  </div>
                  ...
                  <div className="mt-8">
                    ...
                    <p className="text-sm leading-relaxed">
                      Nền tảng của chúng tôi được xây dựng với công nghệ hiện
                      đại nhất, đảm bảo tính bảo mật và hiệu suất cao. StudySync
                      cung cấp giao diện thân thiện, dễ sử dụng và tích hợp
                      nhiều tính năng hỗ trợ học tập đa dạng.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="text-center">
                <div className="inline-flex items-center space-x-2 text-white text-lg md:text-xl font-semibold">
                  ...
                  <span>
                    Bắt đầu học nhóm thông minh cùng StudySync ngay hôm nay!
                  </span>
                </div>
              </div>
            </div>
